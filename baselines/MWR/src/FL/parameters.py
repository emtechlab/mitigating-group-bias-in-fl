...
def get_args():
    ...
    parser.add_argument('--do_training', type=int, default=0, help='client id')

    parser.add_argument('--federated_type', type=str, default='fedavg', choices=['mwr', 'fedavg', 'fedasam', 'fedsam', 'fedadam', 'fedyogi', 'fedadagrad', 'fedprox'])
