...
def runner_train(args, client_loaders, test_loader, device, epoch):
    ...
    for client_id, client in sampled_clients.items():
        ...
        local_param, local_model, avg_grad_norm = client.localround(client_loaders, test_loader, copied_global_weight, epoch)
