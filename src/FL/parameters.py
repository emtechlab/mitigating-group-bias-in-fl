...
def get_args():
    ...
    parser.add_argument('--n_groups', type=int, default=10, help='number of groups')
    parser.add_argument('--eps', type=float, default=1.4, help='dp epsilon value')   # 0.01, 0.4, 0.8, 1.0, 1.4
    parser.add_argument('--lambd', type=float, default=0.003, help='lambda value')
    ...
    parser.add_argument('--federated_type', type=str, default='fedavg', choices=['mwr', 'fedavg', 'term+lipfed', 'afl+lipfed', 'lipfed', 'fedyogi', 'fedadagrad', 'fedprox'])
